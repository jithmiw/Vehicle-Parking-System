...
public class DriverDatabase{
    public static ArrayList<model.Driver> driverTable = new ArrayList<>();

    static {
        driverTable.add(new Driver("Sumith Kumara","7835348345V","B6474845","Panadura",0725637456));
        driverTable.add(new Driver("Amila Pathirana","8826253734V","B3354674","Galle",0717573573));
        driverTable.add(new Driver("Jithmal Perera","9283289272V","B3674589","Horana",0772452457));
        driverTable.add(new Driver("Sumith Dissanayaka","9425245373V","B8366399","Kaluthara",0712673370));
        ...
        driverTable.add(new Driver("Dinesh Udara","9026344373V","B5343783","Hettimulla",0713456675));
